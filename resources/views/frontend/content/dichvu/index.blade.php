...
@section('content')
    <div class="container" style="margin-top: 2%">
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="row">
                    <h5 style="color: #FFAA00"><a href="{{url('/')}}"  style="color: #FFAA00">Trang chủ</a> <span style="color:#707070 "> ></span> <a href="{{url('/dich-vu')}}" style="color: #FFAA00">Dịch vụ</a></h5>
                </div>
                <div class="row" style="margin-left: 5%">
                    <h3 style="font-weight: bold; color: black">Trang Dịch Vụ</h3>
                    <div class="row">
                        <h5 style="color: #b8b6b6;margin-left: 1%">Tổng hợp các thông tin dich vụ của công ty,... </h5>
                    </div>
                </div>
