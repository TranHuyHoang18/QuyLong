...
@endsection
@section('content')
    <div class="container" style="margin-top: 2%" id="main_content">
        <div class="row">
            <div class="col-sm-1"></div>
            <div class="col-sm-10">
                <div class="row">
                    <h5 style="color: #FFAA00"><a href="{{url('/')}}"  style="color: #FFAA00">Trang chủ</a> <span style="color:#707070 "> ></span> <a href="{{url('/lien-he')}}" style="color: #FFAA00"> Liên hệ</a></h5>
                </div>
                ...
                <div class="row" style="margin-top: 3%">
                    ...
                    <div class="col-sm-2">
                        <img src="{{asset('/images/front/icon/acount_1.png')}}" style="width: 70%;margin-left: 15%">
