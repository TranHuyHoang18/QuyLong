        ...
        <form action="#" method="post">
            <div class="row search_top_form">
                <div class="col-md-9" style="border-radius:8px;background-color: white;height: 90%;float: left;margin-top: 1%">
                    ...
                    <input type="text" name="name" placeholder=" Nhập mã đơn hàng ở  đây" style="border: none;width: 90%;margin: 0px auto" value="">
                </div>
...
<div class="row menu">
    ...
    <div class="col-sm-10">
        <div class="row">
            <div class="col-sm-2">
                <div class="logo">
                    <img src="{{asset('images/front/logo/logo1.png')}}" width="100%" alt="">
                </div>
            </div>
            <div class="col-sm-9">
                <ul class="ul-menu" id="main_menu">
                    ...
                    <li>
                        <a href="#">TRA CỨU <i class="fa fa-angle-down" ></i></a>
                        <ul class="sub_menu" style="margin-left: 10%" >
                            <li style="border-bottom: 1px solid #707070; height: 30px;margin-top: 5px;"><a href="{{url('tra-cuu/van-don-van-chuyen')}}">Tra cứu vận đơn</a></li>
                            <li style="border-bottom: 1px solid #707070; height: 30px;margin-top: 5px;"><a href="{{url('tra-cuu/gia-cuoc-van-chuyen')}}">Tra cứu gói cước</a></li>
                            <li style="border-bottom: 1px solid #707070; height: 30px;margin-top: 5px;"><a href="{{url('tra-cuu/diem-gui-hang')}}">Tìm điểm gửi hàng</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#">GIÁ CƯỚC <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                        <ul class="sub_menu" style=" width: 100%" >
                            <div class="row" style="width: 100% ;margin-top:3%;border-bottom: 1px solid #707070;">
                                <div class="col-sm-4">
                                    <li style=" margin-top: 5px; ">
                    ...
                    <li>
                        <a href="#">TIN TỨC <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                        <ul class="sub_menu" style=" width: 100%" >
                            <div class="row" style="width: 100% ;margin-top:3%;border-bottom: 1px solid #707070;">
                                <div class="col-sm-4">
                                    <li style=" margin-top: 5px; ">
                                        <a href="#" style="border-bottom: 1px solid #FFAA00; ">TIN TỨC XE MÁY</a>
                                        <p style="color:#707070">Là gói cước vận chuyển siêu
                                            nhanh bằng đường bộ<br>
                                            Sài Gòn - Hà Nội chỉ 1,900đ/kg<br>
                                            Sài Gòn - Đà Nẵng chỉ 1,300đ/kg</p>
                                ...
                                <div class="col-sm-4">
                                    <li style=" margin-top: 5px;">
                                        <a href="#" style="border-bottom: 1px solid #FFAA00; ">TIN TỨC THÚ CƯNG</a>
                                        <p style="color:#707070">Tra cứu bảng giá gửi xe máy
                                            đi toàn quốc nhanh nhất</p>
                                    </li>
                                </div>
                                <div class="col-sm-4">
                                    <li style=" margin-top: 5px;">
                                        <a href="#" style="border-bottom: 1px solid #FFAA00; ">TIN TỨC VẬN CHUYỂN</a>
                                        <p style="color:#707070">Tra cứu bảng cước vận chuyển
                                            thú cưng an toàn nhất</p>
                                    </li>
                                </div>
                            ...
                            <div class="row" style="width: 100% ">
                                <div class="col-sm-4" style=" margin-top: 5px; ">
                                    <li style=" margin-top: 5px; ">
                                        <a href="#" style="border-bottom: 1px solid #FFAA00; ">TIN TỨC Ô TÔ</a>
                                        <p style="color:#707070">Là gói cước giao hàng tiêu
                                            chuẩn với giá cước cực rẻ<br>
                                            Sài Gòn - Hà Nội chỉ 1,500đ/kg <br>
                                            Sài Gòn - Đà Nẵng chỉ 900đ/kg</p>
                                ...
                                <div class="col-sm-4" style=" margin-top: 5px; ">
                                    <li style=" margin-top: 5px;">
                                        <a href="#" style="border-bottom: 1px solid #FFAA00; ">BLOG QUY LONG</a>
                                        <p style="color:#707070">Tra cứu giá vận chuyển ô tô
                                            đi toàn quốc nhanh nhất</p>
                                    </li>
                                </div>
                    ...
                    <li>
                        ...
                        <ul class="sub_menu" style="margin-left: 60%">
                            @foreach($tuyendung_cates as $tuyendung_cate)
                                <li style="border-bottom: 1px solid #707070;margin-top: 10px;"><a href="{{url('/tuyen-dung/danh-muc/'.$tuyendung_cate->slug)}}">{{$tuyendung_cate->name}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    <li>
