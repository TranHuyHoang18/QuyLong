...
@section('content')
    <div class="row">
        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
            <h4 class="tittle-w3-agileits mb-4">SỬa bài viết trên Blog</h4>
            <form action="{{url('admin/blog/bai-viet/edit/'.$page->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-sm-10">
                        <select name="id_parent">
                            ...
                            @foreach($categories as $category)
                                @if($page->id_category == $category['id'])
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                         <textarea type="text" name="intro" class="form-control mytinymce" id="desc"
                                   placeholder="Mô tả chi tiết" required="" style="height: 100px"><?php echo $page->intro?></textarea>
                    </div>
                </div>
