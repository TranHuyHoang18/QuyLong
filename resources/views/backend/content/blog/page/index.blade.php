...
@section('title')
    Trang quản trị bài viết  trên Blog
@endsection
@section('style')
    <style type="text/css">
...
@section('content')
    <div class="News">
        <h4  style="text-align: center;font-weight: bold;padding-top: 10px;font-size: 32px">Quản trị bài viết  trên Blog</h4>
        <a href="{{url('admin/blog/bai-viet/add')}}">
            ...
            <?php $i =0; ?>
                @foreach($pages as $page)
                    ...
                    <tr>
                        ...
                        <th scope="col">
                            <a href="{{url('admin/blog/bai-viet/detail/'.$page->id)}}" ><button class="btn btn-success">chi tiết</button></a>
                            <a href="{{url('admin/blog/bai-viet/edit/'.$page->id)}}" ><button class="btn btn-warning">Sửa</button></a>
                            <a href="{{url('admin/blog/bai-viet/delete/'.$page->id)}}" ><button class="btn btn-danger">Xóa</button></a>
                        </th>
                    </tr>
                @endforeach
            </tbody>
