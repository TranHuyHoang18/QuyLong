...
@section('content')
    <div class="row">
        <div class="outer-w3-agile col-xl mt-3 mr-xl-3">
            <h4 class="tittle-w3-agileits mb-4">Thêm bài viết mới Giá Cước</h4>
            <form action="{{url('admin/gia-cuoc/bai-viet/add')}}" method="post" enctype="multipart/form-data">
                @csrf
